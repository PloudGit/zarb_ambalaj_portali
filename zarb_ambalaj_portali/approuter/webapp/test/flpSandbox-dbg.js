		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ambalaj Portali Uygulaması",
									"targetURL": "#comappabdiibrahimzarbambalajportali-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappabdiibrahimzarbambalajportali-display": {
								"semanticObject": "comappabdiibrahimzarbambalajportali",
								"action": "display",
								"description": "Ambalaj Portali Uygulaması",
								"title": "Ambalaj Portali Uygulaması",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.abdiibrahim.zarbambalajportali",
									"url": sap.ui.require.toUrl("com/app/abdiibrahim/zarbambalajportali")
								}
							}
						}
					}
